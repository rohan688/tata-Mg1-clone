...
async function email_continue(){
       
  try{
    let prd_body={

    mobileNumber:document.querySelector("mobile_number").value,
    otp:document.querySelector("#one_time_p").value,
    email:document.querySelector("#email_new").value

}
      let res = await fetch("http://localhost:2402/signin",{
          method:"POST",
